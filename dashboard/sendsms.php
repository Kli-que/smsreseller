...
<div class="box-body">
	...
	<form>
		...
		<label for="inputPassword3" class="col-sm-2 form-control-label">Select Group</label>
			<div class="col-sm-10">
				<select class="form-control c-select" id="selectedgroup">
						<?php getAllGroupsSendSMS(); ?>
				</select>
			</div>
		</div><br><br>
