<div class="white bg b-b">
	<div class="navbar no-radius box-shadow-z1">
		...
		<ul class="nav navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link text-muted" data-target="#modal-new" data-toggle="modal" title="New Contact"><span class=""><i class="fa fa-fw fa-plus"></i> <span class="hidden-sm-down">New contact</span></span></a>
			</li>
			...
			<li class="nav-item nav-link" style="margin-left: 50px;">
				...
				<div class="dropdown-menu dropdown-menu-scale pull-right" style="border-color: gray">
						<a class="dropdown-item" id="deletecontact"  data-toggle="modal" data-target="#delete">Delete Contacts</a> 
						<a class="dropdown-item" id="sendtospecific">Send Message</a>
			...
			<li class="nav-item nav-link" style="margin-left: 50px;">
				<div class="form-file">
					<input type="file"><button class="btn white" style="border-color: #4BC0C0"><span class="fa fa-upload"></span> Upload CSV</button>
				</div>
			</li>
			...
			<li class="nav-item nav-link" style="margin-left: 200px;">
				<div>
					<button class="btn btn-info " style="border-color: #4BC0C0"> Balance: <?php /*getAccountBalance();*/ ?></button>
				</div>
			</li>
